...
const GetQuote = () => {
  ...
  return (
    <section ref={quoteRef} className="py-20 bg-white relative overflow-hidden min-h-screen">
      <div className="absolute top-1/4 left-1/4 w-80 h-80 bg-gold-100/30 rounded-full animate-pulse"></div>
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-100/30 rounded-full animate-pulse"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
          <div ref={stepsRef} className="lg:col-span-1">
            ...
            <div className="space-y-6">
              {steps.map((step, index) => (
                <div key={index} className="flex items-start space-x-4 glass-effect rounded-xl p-4 hover:bg-gray-100 transition-all duration-300">
          ...
          <div ref={formRef} className="lg:col-span-2">
            <div className="glass-effect rounded-3xl p-8 hover:bg-gray-100 transition-all duration-300">
              <form onSubmit={handleSubmit} className="space-y-8">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label htmlFor="company" className="block text-gray-600 font-medium mb-2">Company</label>
                      <input
                        type="text"
                        id="company"
                        name="company"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="serviceType" className="block text-gray-600 font-medium mb-2">Service Type *</label>
                      <select
                        id="serviceType"
                        name="serviceType"
                    ...
                    <div>
                      <label htmlFor="shipmentType" className="block text-gray-600 font-medium mb-2">Shipment Type *</label>
                      <select
                        id="shipmentType"
                        name="shipmentType"
                    ...
                    <div>
                      <label htmlFor="origin" className="block text-gray-600 font-medium mb-2">Origin *</label>
                      <input
                        type="text"
                        id="origin"
                        name="origin"
                    ...
                    <div>
                      <label htmlFor="destination" className="block text-gray-600 font-medium mb-2">Destination *</label>
                      <input
                        type="text"
                        id="destination"
                        name="destination"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                      <label htmlFor="weight" className="block text-gray-600 font-medium mb-2">Weight (kg)</label>
                      <input
                        type="number"
                        id="weight"
                        name="weight"
                    ...
                    <div>
                      <label htmlFor="dimensions" className="block text-gray-600 font-medium mb-2">Dimensions (cm)</label>
                      <input
                        type="text"
                        id="dimensions"
                        name="dimensions"
                ...
                <div>
                  <label htmlFor="urgency" className="block text-gray-600 font-medium mb-2">Urgency</label>
                  <select
                    id="urgency"
                    name="urgency"
                ...
                <div>
                  <label htmlFor="description" className="block text-gray-600 font-medium mb-2">Additional Details</label>
                  <textarea
                    id="description"
                    name="description"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 royal-glow hover:scale-105 flex items-center justify-center space-x-2"
                >
