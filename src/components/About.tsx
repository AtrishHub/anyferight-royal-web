...
const About = () => {
  ...
  return (
    <section id="about" ref={aboutRef} className="py-20 bg-white relative overflow-hidden">
      <div className="absolute top-1/3 left-1/4 w-96 h-96 bg-gold-100/30 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-blue-100/30 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div ref={heroRef} className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div ref={imageRef} className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-gold-100/30 to-blue-100/30 rounded-2xl blur-xl"></div>
            <img
              src="./aboutimg.png"
        ...
        <div ref={statsRef} className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="text-center glass-effect rounded-2xl p-8 hover:bg-gray-100 transition-all duration-500 hover:scale-105 group"
            >
        ...
        <div ref={featuresRef} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="glass-effect rounded-2xl p-6 hover:bg-gray-100 transition-all duration-500 group text-center"
              >
                ...
                <h4 className="text-xl font-semibold text-gray-900 mb-2 group-hover:text-gold-500 transition-colors duration-300">
                  {feature.title}
                </h4>
